...
boton.addEventListener("click", (e) =>{
	...
	ventana1=window.open("../envio/listacliente.php","miwin","width=1167,height=568,top=150px,left=250px,scrollbars=yes")
	e.preventDefault();
});
boton2.addEventListener("click",(e) =>{
	ventana2=window.open("../envio/listareceptor.php","miwin","width=1167,height=568,top=150px,left=250px,scrollbars=yes")
	e.preventDefault();	
});
boton3.addEventListener("click",(e) =>{
	ventana3=window.open("../envio/listavehiculo.php","miwin","width=1167,height=568,top=150px,left=250px,scrollbars=yes")
	e.preventDefault();
});
boton4.addEventListener("click",(e) =>{
	ventana4=window.open("../envio/listaplataforma.php","miwin","width=1167,height=568,top=150px,left=250px,scrollbars=yes")
	e.preventDefault();
});
boton5.addEventListener("click",(e) =>{
	ventana5=window.open("../envio/listapiloto.php","miwin","width=1167,height=568,top=150px,left=250px,scrollbars=yes")
	e.preventDefault();
});
boton6.addEventListener("click",(e) =>{
	ventana6=window.open("../envio/listaasignadopiloto.php","miwin","width=1167,height=568,top=150px,left=250px,scrollbars=yes")
	e.preventDefault();
});
