...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="wrapper fadeInDown col-sm-6"><!--efecto de caida-->
            <div id="formContent"><!--contenedor-->
                <div class="fadeIn first">
                    <a href="lista_usuarios_personal.php">
                    <img class="img-fluid" src="../imagenes/personal.png" id="icon" alt="User Icon" style="max-width:60%;width:auto;height:auto;">
                    </a>
                    <h1>Usuarios de Personal </h1>
                    <h3>Administrador/Ejecutivos/Contabilidad </h3>
                </div>
            </div>
        </div>
