...
<?php
  ...
  if($resultado>0){
    ?>
      <h1>Lista de Viajes no autorizados</h1>
      <br>
          ...
          while ($row=mysqli_fetch_array($dt)) {
            ...
            ?>
                  ...
                  <tr>
                    ...
                    <td><center><a href="detalle_viaje2.php?id=<?php echo $id?>&detalle&aut"><button type="button" class="btn btn-info">Detalle</button></a></center></td>    
                </tr>
                 </tbody>
            <?php
